            ...
            {filteredQuizzes.length > 0 ? <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-s24">
                 {filteredQuizzes.map((game, index) => <Card key={game._id} className={`group hover:shadow-akili-md transition-all duration-fast border-0 shadow-akili-sm bg-white animate-scale-in animate-delay-${(index % 5 + 1) * 100}`}>
                  ...
                  (e.target as HTMLImageElement).src = "https://via.placeholder.com/400x300/f97316/ffffff?text=AKILI+GAME+-+erreur+image";
                     ...
                     <CardContent className="p-s20 my-[22px]">
                       ...
                       <div className="flex items-center space-x-s8">
                         <Button variant="outline" size="sm" onClick={() => onEditQuiz(game)} className="flex-1 border-akili-grey-400 text-akili-grey-700 hover:bg-akili-grey-200">
                           {t('mesJeux.modify')}
                         </Button>
                  ...
                  background: 'linear-gradient(135deg, rgb(249, 115, 22), rgb(234, 88, 12))'
                         ...
                         <Button variant="outline" size="sm" onClick={() => handleArchiveGame(game._id)} className="border-yellow-500 text-yellow-700 hover:bg-yellow-50">
                         ...
                         <AlertDialog>
                           ...
                           <AlertDialogContent>
                             ...
                             <AlertDialogFooter>
                               ...
                               <AlertDialogAction onClick={() => handleDeleteGame(game._id)} className="bg-red-600 hover:bg-red-700">
                                 Supprimer
                               </AlertDialogAction>
                             </AlertDialogFooter>
                           </AlertDialogContent>
              ...
              </div> : <div className="text-center py-s48">
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-s16">
            <div>
              ...
              <Input id="game-name" value={newGameName} onChange={e => setNewGameName(e.target.value)} placeholder="Ex: Jeu de Géographie" className="mt-1 border-akili-grey-400 focus:border-akili-purple-500 focus:ring-akili-purple-300" />
            </div>
            ...
            <div>
              ...
              <Input id="game-image" value={newGameImage} onChange={e => setNewGameImage(e.target.value)} placeholder="https://example.com/image.jpg" className="mt-1 border-akili-grey-400 focus:border-akili-purple-500 focus:ring-akili-purple-300" />
            </div>

            {newGameImage && <div className="mt-2">
                <img src={newGameImage} alt={t('quizCreator.preview')} className="w-full h-32 object-cover rounded-akili-md border border-akili-grey-400" onError={e => {
              e.currentTarget.style.display = 'none';
            }} />
              </div>}

            <div className="flex justify-end space-x-3 pt-4">
              <Button variant="outline" onClick={() => setIsCreateDialogOpen(false)} className="border-akili-grey-400 text-akili-grey-700 hover:bg-akili-grey-200">
                {t('quizCreator.cancel')}
              </Button>
              <Button onClick={handleCreateGame} disabled={!newGameName.trim()} className="bg-akili-purple-500 hover:bg-akili-purple-700 text-white">
          ...
          <div className="space-y-s16">
            <div className="grid grid-cols-2 gap-s12">
              <div>
                ...
                <Input id="date-debut" type="date" value={planificationData.date_debut} onChange={e => setPlanificationData(prev => ({
                ...prev,
              ...
              <div>
                ...
                <Input id="date-fin" type="date" value={planificationData.date_fin} onChange={e => setPlanificationData(prev => ({
                ...prev,
                date_fin: e.target.value
              }))} min={planificationData.date_debut} className="mt-1 border-akili-grey-400 focus:border-akili-purple-500" />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-s12">
              <div>
                ...
                <Input id="heure-debut" type="time" value={planificationData.heure_debut} onChange={e => setPlanificationData(prev => ({
                ...prev,
              ...
              <div>
                ...
                <Input id="heure-fin" type="time" value={planificationData.heure_fin} onChange={e => setPlanificationData(prev => ({
                ...prev,
            ...
            <div>
              ...
              <Input id="limite-participant" type="number" min="1" value={planificationData.limite_participant} onChange={e => setPlanificationData(prev => ({
              ...prev,
            ...
            <div>
              ...
              <Select value={planificationData.type} onValueChange={value => setPlanificationData(prev => ({
              ...prev,
              type: value
            }))}>
            ...
            <div className="flex justify-end space-x-3 pt-4">
              <Button variant="outline" onClick={() => setIsPlanificationDialogOpen(false)} className="border-akili-grey-400 text-akili-grey-700 hover:bg-akili-grey-200">
                Annuler
              </Button>
              <Button onClick={handleCreatePlanification} disabled={!planificationData.date_debut || !planificationData.date_fin || !planificationData.heure_debut || !planificationData.heure_fin} className="bg-akili-purple-500 hover:bg-akili-purple-700 text-white">
                Planifier
              </Button>
            </div>
          </div>
