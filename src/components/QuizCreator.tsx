...
import { ArrowLeft, Plus, Save, Eye, Trash2, GripVertical, HelpCircle, CheckSquare, Type, Image } from "lucide-react";
...
export function QuizCreator({ quiz, onNavigate }: QuizCreatorProps) {
  ...
  const questionTypes = [
    { value: "multiple-choice", label: "Choix multiple", icon: CheckSquare },
    { value: "true-false", label: "Vrai/Faux", icon: HelpCircle },
    { value: "text", label: "Réponse libre", icon: Type },
  ];
                  ...
                  {question.type === "multiple-choice" && (
                    <div className="space-y-3">
                      <label className="block text-sm font-medium text-slate-700">
                        Réponses (cliquez pour marquer la bonne réponse)
                      </label>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex space-x-4">
                        <Button
                          ...
                          className={question.correctAnswer === true ? "bg-green-500 hover:bg-green-600" : ""}
                        >
                          Vrai
                        </Button>
                        <Button
                          ...
                          className={question.correctAnswer === false ? "bg-red-500 hover:bg-red-600" : ""}
                        >
                          Faux
                        </Button>
                      </div>
                  ...
                  {questions.map((question, index) => (
                    <Card key={question.id} className="bg-slate-50">
                      <CardContent className="p-4">
                        ...
                        {question.type === "true-false" && (
                          <div className="flex space-x-2">
                            <Badge className={question.correctAnswer ? "bg-green-100 text-green-800" : "bg-slate-100 text-slate-600"}>
                              Vrai {question.correctAnswer ? "✓" : ""}
                            </Badge>
                            <Badge className={!question.correctAnswer ? "bg-green-100 text-green-800" : "bg-slate-100 text-slate-600"}>
                              Faux {!question.correctAnswer ? "✓" : ""}
                            </Badge>
                          </div>
                        )}
                      </CardContent>
