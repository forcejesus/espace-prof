...
export function QuickActions({
  ...
  return <div className="space-y-s20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-s20">
        {quickActions.map((action, index) => <Card key={index} className="group cursor-pointer hover:shadow-akili-lg transition-all duration-fast border-0 shadow-akili-md bg-white transform hover:-translate-y-2" onClick={action.onClick}>
